...
from crm.views import councillor_creation,signin,course_creation,homepage,signout,batch_creation,enquiry_creation,\
    admission_creation,paymentdetails,makepayment,enquirylist,admissionlist,batch_list,batch_payment,councillor_performance
...
urlpatterns = [
    ...
    path('admission/<str:id>/<str:pk>',admission_creation.as_view(),name='admission'),
    ...
    path('batch_payment/<str:id>',batch_payment.as_view(),name='batch_payment'),
    path('councillor_performance',councillor_performance.as_view(),name='councillor')
]
